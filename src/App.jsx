  ...
  return (
    <div className='parent'>
      {jobOpenings.map (function (elem, idx) {
        return <div key={idx}>
          <Card company={elem.companyName} datePosted={elem.datePosted} post={elem.post} brandLogo={elem.brandLogo} pay={elem.pay} tag1={elem.tag1} tag2={elem.tag2} location={elem.location} />
        </div>
      })}
    </div>
  )
